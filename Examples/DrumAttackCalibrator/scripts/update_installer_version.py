...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DrumAttackCalibrator Demo Installer\n"
      else:
        line="OutputBaseFilename=DrumAttackCalibrator Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DrumAttackCalibrator Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DrumAttackCalibrator installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DrumAttackCalibrator Demo installer\n"
     else:
       line="SetupWindowTitle=DrumAttackCalibrator installer\n"
