...
def main():
  ...
  plistpath = scriptpath + "/resources/DrumAttackCalibrator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumAttackCalibrator-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/DrumAttackCalibrator-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/DrumAttackCalibrator-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/DrumAttackCalibrator-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/DrumAttackCalibrator.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/DrumAttackCalibrator.iss",inplace=1):
