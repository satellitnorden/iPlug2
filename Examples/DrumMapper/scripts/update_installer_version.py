...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DrumMapper Demo Installer\n"
      else:
        line="OutputBaseFilename=DrumMapper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DrumMapper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DrumMapper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DrumMapper Demo installer\n"
     else:
       line="SetupWindowTitle=DrumMapper installer\n"
