...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DrumAttackCompanion Demo Installer\n"
      else:
        line="OutputBaseFilename=DrumAttackCompanion Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DrumAttackCompanion Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DrumAttackCompanion installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DrumAttackCompanion Demo installer\n"
     else:
       line="SetupWindowTitle=DrumAttackCompanion installer\n"
