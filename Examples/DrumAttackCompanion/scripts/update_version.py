...
def main():
  ...
  plistpath = scriptpath + "/resources/DrumAttackCompanion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumAttackCompanion-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/DrumAttackCompanion-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/DrumAttackCompanion-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/DrumAttackCompanion-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/DrumAttackCompanion.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/DrumAttackCompanion.iss",inplace=1):
