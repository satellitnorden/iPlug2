...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=EternityDrums Demo Installer\n"
      else:
        line="OutputBaseFilename=EternityDrums Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the EternityDrums Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the EternityDrums installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=EternityDrums Demo installer\n"
     else:
       line="SetupWindowTitle=EternityDrums installer\n"
