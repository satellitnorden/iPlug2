...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InfinityDrums Demo Installer\n"
      else:
        line="OutputBaseFilename=InfinityDrums Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InfinityDrums Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InfinityDrums installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InfinityDrums Demo installer\n"
     else:
       line="SetupWindowTitle=InfinityDrums installer\n"
