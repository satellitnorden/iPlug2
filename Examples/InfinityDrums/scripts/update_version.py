...
def main():
  ...
  plistpath = scriptpath + "/resources/InfinityDrums-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityDrums-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/InfinityDrums-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/InfinityDrums-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/InfinityDrums-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/InfinityDrums.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/InfinityDrums.iss",inplace=1):
