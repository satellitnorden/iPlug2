...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DrumEngine Demo Installer\n"
      else:
        line="OutputBaseFilename=DrumEngine Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DrumEngine Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DrumEngine installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DrumEngine Demo installer\n"
     else:
       line="SetupWindowTitle=DrumEngine installer\n"
