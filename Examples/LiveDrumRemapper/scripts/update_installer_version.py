...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=LiveDrumRemapper Demo Installer\n"
      else:
        line="OutputBaseFilename=LiveDrumRemapper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the LiveDrumRemapper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the LiveDrumRemapper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=LiveDrumRemapper Demo installer\n"
     else:
       line="SetupWindowTitle=LiveDrumRemapper installer\n"
