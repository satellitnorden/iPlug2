...
def main():
  ...
  plistpath = scriptpath + "/resources/LiveDrumRemapper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/LiveDrumRemapper-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/LiveDrumRemapper-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/LiveDrumRemapper-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/LiveDrumRemapper-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/LiveDrumRemapper.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/LiveDrumRemapper.iss",inplace=1):
