...
def  main():
  ...
  installer = "\installer\ProceduralDrummer Installer.exe"
   
  if demo:
    installer = "\installer\ProceduralDrummer Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\ProceduralDrummer manual.pdf" 
  ]
  ...
  ZIPNAME = "ProceduralDrummer-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "ProceduralDrummer-v" + FULLVERSIONSTR + "-win-demo.zip"
