...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ProceduralDrummer Demo Installer\n"
      else:
        line="OutputBaseFilename=ProceduralDrummer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ProceduralDrummer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ProceduralDrummer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ProceduralDrummer Demo installer\n"
     else:
       line="SetupWindowTitle=ProceduralDrummer installer\n"
