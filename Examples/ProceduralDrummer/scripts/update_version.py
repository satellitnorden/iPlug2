...
def main():
  ...
  plistpath = scriptpath + "/resources/ProceduralDrummer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ProceduralDrummer-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/ProceduralDrummer-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ProceduralDrummer-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ProceduralDrummer-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/ProceduralDrummer.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/ProceduralDrummer.iss",inplace=1):
