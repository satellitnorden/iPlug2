...
def main():
  ...
  plistpath = scriptpath + "/resources/DaybreakPanInvert-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakPanInvert-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/DaybreakPanInvert-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/DaybreakPanInvert-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/DaybreakPanInvert-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/DaybreakPanInvert.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/DaybreakPanInvert.iss",inplace=1):
