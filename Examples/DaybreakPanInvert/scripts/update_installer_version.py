...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DaybreakPanInvert Demo Installer\n"
      else:
        line="OutputBaseFilename=DaybreakPanInvert Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DaybreakPanInvert Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DaybreakPanInvert installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DaybreakPanInvert Demo installer\n"
     else:
       line="SetupWindowTitle=DaybreakPanInvert installer\n"
