...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InfinityGuitar Demo Installer\n"
      else:
        line="OutputBaseFilename=InfinityGuitar Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InfinityGuitar Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InfinityGuitar installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InfinityGuitar Demo installer\n"
     else:
       line="SetupWindowTitle=InfinityGuitar installer\n"
