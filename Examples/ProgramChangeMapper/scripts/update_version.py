...
def main():
  ...
  plistpath = scriptpath + "/resources/ProgramChangeMapper-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ProgramChangeMapper-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/ProgramChangeMapper-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ProgramChangeMapper-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/ProgramChangeMapper-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/ProgramChangeMapper.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/ProgramChangeMapper.iss",inplace=1):
