...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ProgramChangeMapper Demo Installer\n"
      else:
        line="OutputBaseFilename=ProgramChangeMapper Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ProgramChangeMapper Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ProgramChangeMapper installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ProgramChangeMapper Demo installer\n"
     else:
       line="SetupWindowTitle=ProgramChangeMapper installer\n"
