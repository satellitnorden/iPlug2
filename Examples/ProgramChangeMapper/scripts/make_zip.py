...
def  main():
  ...
  installer = "\installer\ProgramChangeMapper Installer.exe"
   
  if demo:
    installer = "\installer\ProgramChangeMapper Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\ProgramChangeMapper manual.pdf" 
  ]
  ...
  ZIPNAME = "ProgramChangeMapper-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "ProgramChangeMapper-v" + FULLVERSIONSTR + "-win-demo.zip"
