...
def  main():
  ...
  installer = "\installer\PangaeaDrums Installer.exe"
   
  if demo:
    installer = "\installer\PangaeaDrums Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\PangaeaDrums manual.pdf" 
  ]
  ...
  ZIPNAME = "PangaeaDrums-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "PangaeaDrums-v" + FULLVERSIONSTR + "-win-demo.zip"
