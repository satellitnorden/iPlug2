...
def main():
  ...
  plistpath = scriptpath + "/resources/PangaeaDrums-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PangaeaDrums-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/PangaeaDrums-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/PangaeaDrums-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/PangaeaDrums-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/PangaeaDrums.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/PangaeaDrums.iss",inplace=1):
