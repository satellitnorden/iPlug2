...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PangaeaDrums Demo Installer\n"
      else:
        line="OutputBaseFilename=PangaeaDrums Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PangaeaDrums Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PangaeaDrums installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PangaeaDrums Demo installer\n"
     else:
       line="SetupWindowTitle=PangaeaDrums installer\n"
