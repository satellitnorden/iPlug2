...
def main():
  ...
  plistpath = scriptpath + "/resources/GuitarChartTranslator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GuitarChartTranslator-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/GuitarChartTranslator-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/GuitarChartTranslator-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/GuitarChartTranslator-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/GuitarChartTranslator.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/GuitarChartTranslator.iss",inplace=1):
