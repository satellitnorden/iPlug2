...
def  main():
  ...
  installer = "\installer\GuitarChartTranslator Installer.exe"
   
  if demo:
    installer = "\installer\GuitarChartTranslator Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\GuitarChartTranslator manual.pdf" 
  ]
  ...
  ZIPNAME = "GuitarChartTranslator-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "GuitarChartTranslator-v" + FULLVERSIONSTR + "-win-demo.zip"
