...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=GuitarChartTranslator Demo Installer\n"
      else:
        line="OutputBaseFilename=GuitarChartTranslator Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the GuitarChartTranslator Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the GuitarChartTranslator installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=GuitarChartTranslator Demo installer\n"
     else:
       line="SetupWindowTitle=GuitarChartTranslator installer\n"
