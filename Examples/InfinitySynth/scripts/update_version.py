...
def main():
  ...
  plistpath = scriptpath + "/resources/InfinitySynth-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinitySynth-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/InfinitySynth-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/InfinitySynth-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/InfinitySynth-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/InfinitySynth.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/InfinitySynth.iss",inplace=1):
