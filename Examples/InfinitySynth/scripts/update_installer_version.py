...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InfinitySynth Demo Installer\n"
      else:
        line="OutputBaseFilename=InfinitySynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InfinitySynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InfinitySynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InfinitySynth Demo installer\n"
     else:
       line="SetupWindowTitle=InfinitySynth installer\n"
