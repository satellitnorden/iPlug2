...
def main():
  ...
  plistpath = scriptpath + "/resources/InfinitySampler-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinitySampler-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/InfinitySampler-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/InfinitySampler-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/InfinitySampler-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/InfinitySampler.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/InfinitySampler.iss",inplace=1):
