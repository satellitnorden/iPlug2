...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DaybreakGain Demo Installer\n"
      else:
        line="OutputBaseFilename=DaybreakGain Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DaybreakGain Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DaybreakGain installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DaybreakGain Demo installer\n"
     else:
       line="SetupWindowTitle=DaybreakGain installer\n"
