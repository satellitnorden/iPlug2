...
def main():
  ...
  plistpath = scriptpath + "/resources/DaybreakGain-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakGain-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakGain-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakGain-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakGain-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DaybreakGain.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DaybreakGain.iss",inplace=1):
