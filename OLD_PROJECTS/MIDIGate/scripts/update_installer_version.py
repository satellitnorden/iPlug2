...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=MIDIGate Demo Installer\n"
      else:
        line="OutputBaseFilename=MIDIGate Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the MIDIGate Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the MIDIGate installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=MIDIGate Demo installer\n"
     else:
       line="SetupWindowTitle=MIDIGate installer\n"
