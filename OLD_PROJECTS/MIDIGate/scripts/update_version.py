...
def main():
  ...
  plistpath = scriptpath + "/resources/MIDIGate-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MIDIGate-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MIDIGate-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MIDIGate-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MIDIGate-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/MIDIGate.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/MIDIGate.iss",inplace=1):
