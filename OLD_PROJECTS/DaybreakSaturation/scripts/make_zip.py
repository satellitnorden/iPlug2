...
def  main():
  ...
  installer = "\installer\DaybreakSaturation Installer.exe"
   
  if demo:
    installer = "\installer\DaybreakSaturation Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\DaybreakSaturation manual.pdf" 
  ]
  ...
  ZIPNAME = "DaybreakSaturation-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "DaybreakSaturation-v" + FULLVERSIONSTR + "-win-demo.zip"
