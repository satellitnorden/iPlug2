...
def main():
  ...
  plistpath = scriptpath + "/resources/DaybreakSaturation-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSaturation-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSaturation-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSaturation-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSaturation-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DaybreakSaturation.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DaybreakSaturation.iss",inplace=1):
