...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DaybreakSaturation Demo Installer\n"
      else:
        line="OutputBaseFilename=DaybreakSaturation Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DaybreakSaturation Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DaybreakSaturation installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DaybreakSaturation Demo installer\n"
     else:
       line="SetupWindowTitle=DaybreakSaturation installer\n"
