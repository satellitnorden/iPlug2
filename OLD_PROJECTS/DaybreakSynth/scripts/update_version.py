...
def main():
  ...
  plistpath = scriptpath + "/resources/DaybreakSynth-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSynth-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSynth-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSynth-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakSynth-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DaybreakSynth.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DaybreakSynth.iss",inplace=1):
