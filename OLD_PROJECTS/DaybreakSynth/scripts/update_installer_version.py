...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DaybreakSynth Demo Installer\n"
      else:
        line="OutputBaseFilename=DaybreakSynth Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DaybreakSynth Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DaybreakSynth installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DaybreakSynth Demo installer\n"
     else:
       line="SetupWindowTitle=DaybreakSynth installer\n"
