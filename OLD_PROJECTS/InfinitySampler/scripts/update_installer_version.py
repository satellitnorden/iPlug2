...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InfinitySampler Demo Installer\n"
      else:
        line="OutputBaseFilename=InfinitySampler Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InfinitySampler Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InfinitySampler installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InfinitySampler Demo installer\n"
     else:
       line="SetupWindowTitle=InfinitySampler installer\n"
