...
def main():
  ...
  plistpath = scriptpath + "/resources/InfinityGuitar-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityGuitar-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityGuitar-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityGuitar-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityGuitar-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/InfinityGuitar.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/InfinityGuitar.iss",inplace=1):
