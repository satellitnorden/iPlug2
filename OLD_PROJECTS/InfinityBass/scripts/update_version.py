...
def main():
  ...
  plistpath = scriptpath + "/resources/InfinityBass-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityBass-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityBass-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityBass-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/InfinityBass-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/InfinityBass.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/InfinityBass.iss",inplace=1):
