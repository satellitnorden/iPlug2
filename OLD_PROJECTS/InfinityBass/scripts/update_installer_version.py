...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=InfinityBass Demo Installer\n"
      else:
        line="OutputBaseFilename=InfinityBass Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the InfinityBass Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the InfinityBass installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=InfinityBass Demo installer\n"
     else:
       line="SetupWindowTitle=InfinityBass installer\n"
