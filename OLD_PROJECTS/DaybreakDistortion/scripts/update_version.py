...
def main():
  ...
  plistpath = scriptpath + "/resources/DaybreakDistortion-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakDistortion-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakDistortion-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakDistortion-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DaybreakDistortion-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DaybreakDistortion.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DaybreakDistortion.iss",inplace=1):
