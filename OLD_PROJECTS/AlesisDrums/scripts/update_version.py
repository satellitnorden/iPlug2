...
def main():
  ...
  plistpath = scriptpath + "/resources/AlesisDrums-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrums-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrums-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrums-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrums-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/AlesisDrums.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AlesisDrums.iss",inplace=1):
