...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=AlesisDrums Demo Installer\n"
      else:
        line="OutputBaseFilename=AlesisDrums Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the AlesisDrums Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the AlesisDrums installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=AlesisDrums Demo installer\n"
     else:
       line="SetupWindowTitle=AlesisDrums installer\n"
