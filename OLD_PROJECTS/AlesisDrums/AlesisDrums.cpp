...
{
  //Define constants.
  const uint32 NUMBER_OF_DRUM_PARTS{ 24 };
...
AlesisDrums::AlesisDrums(const InstanceInfo& info)
...
void AlesisDrums::ProcessBlock(iplug::sample** inputs, iplug::sample** outputs, const int32 number_of_frames)
{
      ...
      if (message.StatusMsg() == iplug::IMidiMsg::kNoteOn)
      {
        ...
        for (const DrumPart triggered_drum_part : triggered_drum_parts)
        {
          ...
          if (triggered_drum_part == DrumPart::HIHAT_PEDAL)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_FULLY_CLOSED
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_0
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_1
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_2
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_3
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_4
          ...
          if (triggered_drum_part == DrumPart::HIHAT_FULLY_CLOSED)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_LEVEL_0
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_1
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_2
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_3
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_4
          ...
          if (triggered_drum_part == DrumPart::HIHAT_LEVEL_0)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_LEVEL_1
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_2
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_3
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_4
                || playing_note._DrumPart == DrumPart::HIHAT_FULLY_OPEN)
          ...
          if (triggered_drum_part == DrumPart::HIHAT_LEVEL_1)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_LEVEL_2
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_3
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_4
                || playing_note._DrumPart == DrumPart::HIHAT_FULLY_OPEN)
              {
          ...
          if (triggered_drum_part == DrumPart::HIHAT_LEVEL_2)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_LEVEL_3
                || playing_note._DrumPart == DrumPart::HIHAT_LEVEL_4
                || playing_note._DrumPart == DrumPart::HIHAT_FULLY_OPEN)
              {
                playing_note._SoundResourcePlayer.Stop();
          ...
          if (triggered_drum_part == DrumPart::HIHAT_LEVEL_3)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_LEVEL_4
                || playing_note._DrumPart == DrumPart::HIHAT_FULLY_OPEN)
              {
                playing_note._SoundResourcePlayer.Stop();
              }
...
void AlesisDrums::ProcessMidiMsg(const iplug::IMidiMsg& msg)
{
  _MidiQueue.Add(msg);
}
#endif
...
* Exports packages.
*/
void AlesisDrums::ExportPackages() NOEXCEPT
{
  //Define constants.
...

  {
    ...
    sprintf_s(package_file_buffer, "C:\\Github\\Audio-Data\\Plugins\\Instruments\\AlesisDrumsSamples\\AlesisDrumsPackage_%u", ++package_counter);
...
* Imports packages.
*/
void AlesisDrums::ImportPackages() NOEXCEPT
{
  //Cache the folder.
  DynamicString folder{ RetrievePluginPath("AlesisDrums.vst3") };
  ...
  {
    char package_file_buffer[128];
    sprintf_s(package_file_buffer, "%s\\AlesisDrumsPackage_%u", folder.Data(), ++package_counter);
