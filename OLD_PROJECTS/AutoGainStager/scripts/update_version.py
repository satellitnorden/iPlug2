...
def main():
  ...
  plistpath = scriptpath + "/resources/AutoGainStager-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoGainStager-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoGainStager-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoGainStager-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AutoGainStager-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/AutoGainStager.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AutoGainStager.iss",inplace=1):
