...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=AutoGainStager Demo Installer\n"
      else:
        line="OutputBaseFilename=AutoGainStager Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the AutoGainStager Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the AutoGainStager installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=AutoGainStager Demo installer\n"
     else:
       line="SetupWindowTitle=AutoGainStager installer\n"
