...
class SecondSectionGenerator : public SectionGenerator
{
  ...
  FORCE_INLINE void OnMIDIEvent(const OnMIDIEventContext &context) NOEXCEPT override
  {
    switch (context._NoteNumber)
    {
      case ProceduralMusicianConstants::KICK_NOTE_NUMBER:
      {
        ...
        ProceduralMusicianRythmGuitar::AddOutgoingMIDIEvent(context, ProceduralMusicianRythmGuitar::Channel::BOTH, ProceduralMusicianRythmGuitar::Type::MUTED, NoteDuration::SIXTEENTH, NoteType::REGULAR);
