...
class ThirdSectionGenerator : public SectionGenerator
{
    ...
    switch (context._NoteNumber)
    {
      case ProceduralMusicianConstants::KICK_NOTE_NUMBER:
      {
        ...
        //Send the left rythm guitar message.
        {
          ...
          {
            iplug::IMidiMsg output_message;
            output_message.MakeNoteOnMsg(40, 127, 0, ProceduralMusicianConstants::LEFT_RYTHM_GUITAR_CHANNEL);
        ...
        //Send the right rythm guitar message.
        {
          ...
          {
            iplug::IMidiMsg output_message;
            output_message.MakeNoteOnMsg(40, 127, 0, ProceduralMusicianConstants::RIGHT_RYTHM_GUITAR_CHANNEL);
