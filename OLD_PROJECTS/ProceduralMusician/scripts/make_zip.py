...
def  main():
  ...
  installer = "\installer\ProceduralMusician Installer.exe"
   
  if demo:
    installer = "\installer\ProceduralMusician Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\ProceduralMusician manual.pdf" 
  ]
  ...
  ZIPNAME = "ProceduralMusician-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "ProceduralMusician-v" + FULLVERSIONSTR + "-win-demo.zip"
