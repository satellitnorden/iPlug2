...
def main():
  ...
  plistpath = scriptpath + "/resources/ProceduralMusician-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ProceduralMusician-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ProceduralMusician-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ProceduralMusician-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/ProceduralMusician-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/ProceduralMusician.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/ProceduralMusician.iss",inplace=1):
