...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=ProceduralMusician Demo Installer\n"
      else:
        line="OutputBaseFilename=ProceduralMusician Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the ProceduralMusician Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the ProceduralMusician installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=ProceduralMusician Demo installer\n"
     else:
       line="SetupWindowTitle=ProceduralMusician installer\n"
