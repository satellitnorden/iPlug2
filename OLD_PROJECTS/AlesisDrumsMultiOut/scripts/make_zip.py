...
def  main():
  ...
  installer = "\installer\AlesisDrumsMultiOut Installer.exe"
   
  if demo:
    installer = "\installer\AlesisDrumsMultiOut Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\AlesisDrumsMultiOut manual.pdf" 
  ]
  ...
  ZIPNAME = "AlesisDrumsMultiOut-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "AlesisDrumsMultiOut-v" + FULLVERSIONSTR + "-win-demo.zip"
