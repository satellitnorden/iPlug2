...
def main():
  ...
  plistpath = scriptpath + "/resources/AlesisDrumsMultiOut-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrumsMultiOut-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrumsMultiOut-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrumsMultiOut-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/AlesisDrumsMultiOut-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/AlesisDrumsMultiOut.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/AlesisDrumsMultiOut.iss",inplace=1):
