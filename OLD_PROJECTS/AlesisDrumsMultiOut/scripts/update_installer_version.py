...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=AlesisDrumsMultiOut Demo Installer\n"
      else:
        line="OutputBaseFilename=AlesisDrumsMultiOut Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the AlesisDrumsMultiOut Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the AlesisDrumsMultiOut installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=AlesisDrumsMultiOut Demo installer\n"
     else:
       line="SetupWindowTitle=AlesisDrumsMultiOut installer\n"
