...
//Alesis drums logic.
namespace AlesisDrumsLogic
{

  /*
  * Returns the subchannel index for the given drum part.
  */
  FORCE_INLINE NO_DISCARD uint32 SubChannelIndex(const DrumPart drum_part) NOEXCEPT
  {
    return UNDERLYING(drum_part) + 1;
  }
...
{
  //Define constants.
  const uint32 NUMBER_OF_DRUM_PARTS{ 25 };
  ...
  constexpr StaticArray<int32, NUMBER_OF_DRUM_PARTS> DRUM_PART_DURATIONS
  {
    1,
    2,
    2,
  ...
  for (uint64 i{ 0 }; i < DRUM_PART_NAMES.Size(); ++i)
  {
    ...
    const uint32 drum_part_duration{ static_cast<uint32>(DRUM_PART_DURATIONS[i]) };

    for (uint32 velocity_index{ 0 }; velocity_index < AlesisDrumsConstants::NUMBER_OF_LAYERS; ++velocity_index)
    {
      for (uint32 sample_index{ 0 }; sample_index < AlesisDrumsConstants::NUMBER_OF_LAYERS; ++sample_index)
      {
        file << "R" << ++region_counter << "," << drum_part_name << "_VELOCITY_" << velocity_index << "_" << sample_index + 1 << "," <<  start_counter << ".1.00," << start_counter + drum_part_duration << ".1.00,1.0.00" << std::endl;
...
AlesisDrumsMultiOut::AlesisDrumsMultiOut(const InstanceInfo& info)
: Plugin(info, MakeConfig(0, 1))
{
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::KICK)]._VelocityCurve = DrumPartProperties::VelocityCurve::HALF_INVERSE_SQUARE;
  _DrumPartProperties[UNDERLYING(DrumPart::KICK)]._RetriggerCancelTime = 0.016f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::SNARE)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::CHINA)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BOW)]._VelocityCurve = DrumPartProperties::VelocityCurve::HALF_INVERSE_SQUARE;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BOW)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BOW)]._Pan = CYMBALS_PANNING / 4.0f * 2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BOW)]._Gain = 1.0f; //0.025f step.
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BELL)]._VelocityCurve = DrumPartProperties::VelocityCurve::HALF_INVERSE_SQUARE;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BELL)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BELL)]._Pan = CYMBALS_PANNING / 4.0f * 2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_BELL)]._Gain = 1.0f; //0.025f step.
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_EDGE)]._VelocityCurve = DrumPartProperties::VelocityCurve::HALF_INVERSE_SQUARE;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_EDGE)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_EDGE)]._Pan = CYMBALS_PANNING / 4.0f * 2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::RIDE_EDGE)]._Gain = 1.0f; //0.025f step.
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::LEFT_CRASH)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::SPLASH)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::RIGHT_CRASH)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_PEDAL)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_PEDAL)]._Pan = CYMBALS_PANNING / 4.0f * -2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_PEDAL)]._Gain = 0.975f; //0.025f step.
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_FULLY_CLOSED)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_FULLY_CLOSED)]._Pan = CYMBALS_PANNING / 4.0f * -2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_FULLY_CLOSED)]._Gain = 0.975f; //0.025f step.

  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_HALFWAY)]._DrumPartString = "HIHAT_HALFWAY";
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_HALFWAY)]._MidiNumber = 44;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_HALFWAY)]._VelocityCurve = DrumPartProperties::VelocityCurve::LINEAR;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_HALFWAY)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_HALFWAY)]._Pan = CYMBALS_PANNING / 4.0f * -2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_HALFWAY)]._Gain = 0.975f; //0.025f step.
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_FULLY_OPEN)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_FULLY_OPEN)]._Pan = CYMBALS_PANNING / 4.0f * -2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::HIHAT_FULLY_OPEN)]._Gain = 0.975f; //0.025f step.
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::LEFT_WIDE_CRASH)]._RetriggerCancelTime = 0.008f;
  ...
  _DrumPartProperties[UNDERLYING(DrumPart::STACK)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::STACK)]._Pan = CYMBALS_PANNING / 4.0f * -2.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::STACK)]._Gain = 0.975f; //0.025f step.

  _DrumPartProperties[UNDERLYING(DrumPart::KICK_ROOM)]._DrumPartString = "KICK_ROOM";
  _DrumPartProperties[UNDERLYING(DrumPart::KICK_ROOM)]._MidiNumber = 24;
  _DrumPartProperties[UNDERLYING(DrumPart::KICK_ROOM)]._VelocityCurve = DrumPartProperties::VelocityCurve::HALF_INVERSE_SQUARE;
  _DrumPartProperties[UNDERLYING(DrumPart::KICK_ROOM)]._RetriggerCancelTime = 0.016f;
  _DrumPartProperties[UNDERLYING(DrumPart::KICK_ROOM)]._Pan = 0.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::KICK_ROOM)]._Gain = 1.0f;

  _DrumPartProperties[UNDERLYING(DrumPart::SNARE_ROOM)]._DrumPartString = "SNARE_ROOM";
  _DrumPartProperties[UNDERLYING(DrumPart::SNARE_ROOM)]._MidiNumber = 26;
  _DrumPartProperties[UNDERLYING(DrumPart::SNARE_ROOM)]._VelocityCurve = DrumPartProperties::VelocityCurve::LINEAR;
  _DrumPartProperties[UNDERLYING(DrumPart::SNARE_ROOM)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::SNARE_ROOM)]._Pan = 0.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::SNARE_ROOM)]._Gain = 1.0f;

  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1_ROOM)]._DrumPartString = "TOM_1_ROOM";
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1_ROOM)]._MidiNumber = 35;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1_ROOM)]._VelocityCurve = DrumPartProperties::VelocityCurve::LINEAR;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1_ROOM)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1_ROOM)]._Pan = 0.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_1_ROOM)]._Gain = 1.0f;

  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2_ROOM)]._DrumPartString = "TOM_2_ROOM";
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2_ROOM)]._MidiNumber = 36;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2_ROOM)]._VelocityCurve = DrumPartProperties::VelocityCurve::LINEAR;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2_ROOM)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2_ROOM)]._Pan = 0.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_2_ROOM)]._Gain = 1.0f;

  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3_ROOM)]._DrumPartString = "TOM_3_ROOM";
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3_ROOM)]._MidiNumber = 37;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3_ROOM)]._VelocityCurve = DrumPartProperties::VelocityCurve::LINEAR;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3_ROOM)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3_ROOM)]._Pan = 0.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_3_ROOM)]._Gain = 1.0f;

  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4_ROOM)]._DrumPartString = "TOM_4_ROOM";
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4_ROOM)]._MidiNumber = 38;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4_ROOM)]._VelocityCurve = DrumPartProperties::VelocityCurve::LINEAR;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4_ROOM)]._RetriggerCancelTime = 0.008f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4_ROOM)]._Pan = 0.0f;
  _DrumPartProperties[UNDERLYING(DrumPart::TOM_4_ROOM)]._Gain = 1.0f;
...
#if IPLUG_DSP
void AlesisDrumsMultiOut::OnReset()
{
...
void AlesisDrumsMultiOut::ProcessBlock(iplug::sample** inputs, iplug::sample** outputs, const int32 number_of_frames)
{
  ...
  for (int32 i{ 0 }; i < number_of_frames; ++i)
  {
    ...
    while (!_MidiQueue.Empty())
    {
      ...
      if (message.StatusMsg() == iplug::IMidiMsg::kNoteOn)
      {
        ...
        uint32 triggered_drum_parts_counter{ 0 };
        ...
        for (const DrumPart triggered_drum_part : triggered_drum_parts)
        {
          if (triggered_drum_part != DrumPart::NONE
            && _DrumPartProperties[UNDERLYING(triggered_drum_part)]._TimeSinceLastTrigger >= _DrumPartProperties[UNDERLYING(triggered_drum_part)]._RetriggerCancelTime)
          {
            _DrumPartProperties[UNDERLYING(triggered_drum_part)]._TimeSinceLastTrigger = 0.0f;
            ...
            {
              first_velocity_index = CatalystBaseMath::Floor<uint64>(velocity * static_cast<float32>(_DrumPartProperties[UNDERLYING(triggered_drum_part)]._SoundResources.LastIndex()));
          ...
          if (triggered_drum_part == DrumPart::HIHAT_PEDAL)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_FULLY_CLOSED
                || playing_note._DrumPart == DrumPart::HIHAT_HALFWAY
          ...
          if (triggered_drum_part == DrumPart::HIHAT_FULLY_CLOSED)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
              if (playing_note._DrumPart == DrumPart::HIHAT_HALFWAY
                || playing_note._DrumPart == DrumPart::HIHAT_FULLY_OPEN)
              {
                playing_note._SoundResourcePlayer.Stop();
              }
          ...
          if (triggered_drum_part == DrumPart::HIHAT_HALFWAY)
          {
            for (PlayingNote& playing_note : _PlayingNotes)
            {
    ...
    //Update the time since the last trigger.
    {
      for (DrumPartProperties &drum_part_properties : _DrumPartProperties)
      {
        drum_part_properties._TimeSinceLastTrigger += time_per_sample;
      }
    }
    ...
    for (int32 sub_channel_index{ 0 }; sub_channel_index < UNDERLYING(DrumPart::NUMBER_OF_DRUM_PARTS) + 1; ++sub_channel_index)
    {
      for (int32 channel_index{ 0 }; channel_index < 2; ++channel_index)
      {
        float32 value{ 0.0f };

        for (PlayingNote& playing_note : _PlayingNotes)
        {
          if (AlesisDrumsLogic::SubChannelIndex(playing_note._DrumPart) == sub_channel_index)
          {
            value += playing_note._SoundResourcePlayer.NextSample(channel_index);
          }
        }

        outputs[(sub_channel_index * 2) + channel_index][i] = value;
      }
    }
...
void AlesisDrumsMultiOut::ProcessMidiMsg(const iplug::IMidiMsg& msg)
{
  _MidiQueue.Add(msg);
}
#endif
...
* Exports packages.
*/
void AlesisDrumsMultiOut::ExportPackages() NOEXCEPT
{
  //Define constants.
...

  {
    ...
    sprintf_s(package_file_buffer, "C:\\Github\\Audio-Data\\Drum Samples\\Alesis Drums\\AlesisDrumsMultiOutPackage_%u", ++package_counter);
  ...
  for (uint32 i{ 0 }; i < UNDERLYING(DrumPart::NUMBER_OF_DRUM_PARTS); ++i)
  {
    DrumPartProperties& drum_part_properties{ _DrumPartProperties[i] };

    bool found_velocity{ true };
    uint32 velocity_index{ 0 };

    while (found_velocity)
    {
      for (uint32 j{ 0 }; j < AlesisDrumsConstants::NUMBER_OF_LAYERS; ++j)
      {
        SoundResource sound_resource;

        sprintf_s(sound_file_buffer, "C:\\Alesis Drums MultiOut Temporary\\%s_VELOCITY_%u_%u.wav", drum_part_properties._DrumPartString, velocity_index, j + 1);
...
* Imports packages.
*/
void AlesisDrumsMultiOut::ImportPackages() NOEXCEPT
{
  //Cache the folder.
  DynamicString folder{ RetrievePluginPath("AlesisDrumsMultiOut.vst3") };
  ...
  {
    char package_file_buffer[256];
    sprintf_s(package_file_buffer, "%s\\AlesisDrumsMultiOutPackage_%u", folder.Data(), ++package_counter);
