...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DrumMIDIGenerator Demo Installer\n"
      else:
        line="OutputBaseFilename=DrumMIDIGenerator Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DrumMIDIGenerator Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DrumMIDIGenerator installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DrumMIDIGenerator Demo installer\n"
     else:
       line="SetupWindowTitle=DrumMIDIGenerator installer\n"
