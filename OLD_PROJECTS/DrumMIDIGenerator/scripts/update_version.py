...
def main():
  ...
  plistpath = scriptpath + "/resources/DrumMIDIGenerator-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumMIDIGenerator-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumMIDIGenerator-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumMIDIGenerator-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DrumMIDIGenerator-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DrumMIDIGenerator.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DrumMIDIGenerator.iss",inplace=1):
